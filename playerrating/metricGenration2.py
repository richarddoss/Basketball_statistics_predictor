...
def elo(playerRating, minutesPlayed, Team1, Team2, TotTime, plusminus):
    ...
    for fixedPlayer in playerRating[Team1]:
        ...
        sum=sum+playerRating[Team1][fixedPlayer]
    ...
    for row1 in reader1:
        if i > 0:
            ...
            if not (c in checklist):
                ...
                sumTeam = 0
                #sum=0
                #for inTeam in playerRating:
                #    for x in playerRating[inTeam]:
                #        sum=sum+playerRating[inTeam][x]
                #print("Sum of individuals",sum)
                #time.sleep(2)
