...
#teamRating2,a2,MSE = e1.estimate1(2,teamRatingTrue)
playerRating,minutesPlayedEstimate,MSE=p.estimate(10,2500,minutesPlayedTrue,playerRatingTrue)
#print("2")
...
plt.title("System parameters: eta=2500, gamma=10")
plt.show()