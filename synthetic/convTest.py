...
playerRating,minutesPlayedEstimate,a1,MSE=p.estimate(50,minutesPlayedTrue,playerRatingTrue)
#print("2")
...
plt.title("System parameters: gamma value=50 and eta value=2500")
plt.show()