...
#time.sleep(20)
K1=[10,20,100,200,500,750,1000,1200]
K2=[2,5,10,20,50,100,200,500]
N=8
MSE1=np.zeros((N,10))
MSE2=np.zeros((N,10))
for j in range(10):
    ...
    for i in range(N):
        playerRating,minutesPlayedEstimate=e.estimate(K1[i])
        teamRating2 = e1.estimate1(K2[i])
...
csv_file1.close()
plt.plot(K1,MSE1final)
plt.plot(K2,MSE2final)
plt.xlabel("K value")
