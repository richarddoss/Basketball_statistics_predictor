...
for g in range(3):
    for e in range(3):
        ...
        for row1 in reader1:
            ...
            if i > 0:
                ...
                if (flag==1):
                    ...
                    playerRating= f.eloModified(playerRating, minutesPlayed, Team1, Team2, int(row1[4]), plusminus1, plusminus2, gamma[g], eta[e])
                    m1 = 0
                    m2 = 0
                    p1=0
                    p2=0
        ...
        for row1 in reader1:
            ...
            i = i + 1
        print("gamma value",gamma[g],"eta value ",eta[e],f.logLoss(y_true,y_pred),noOfPredictions)